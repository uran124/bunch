...
// Outbound Telegram relay (old hosting -> VPS)
$defineIfMissing('TG_OUTBOUND_RELAY_URL', $readEnv('TG_OUTBOUND_RELAY_URL') ?? '');
$defineIfMissing('TG_OUTBOUND_RELAY_KEY', $readEnv('TG_OUTBOUND_RELAY_KEY') ?? '');
