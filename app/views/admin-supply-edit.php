        ...
        <div class="grid gap-3 lg:grid-cols-2">
            ...
            <label class="flex flex-col gap-2 text-sm font-semibold text-slate-700">
                ...
                <span class="inline-flex items-center gap-2 text-xs font-medium text-slate-600">
                    <input name="export_stem_height_attribute" type="checkbox" class="h-3.5 w-3.5 rounded border-slate-300 text-rose-600 focus:ring-rose-500" <?php echo !empty($supply['export_stem_height_attribute']) ? 'checked' : ''; ?>>
            ...
            <label class="flex flex-col gap-2 text-sm font-semibold text-slate-700">
                ...
                <span class="inline-flex items-center gap-2 text-xs font-medium text-slate-600">
                    <input name="export_stem_weight_attribute" type="checkbox" class="h-3.5 w-3.5 rounded border-slate-300 text-rose-600 focus:ring-rose-500" <?php echo !empty($supply['export_stem_weight_attribute']) ? 'checked' : ''; ?>>
                    Вынести в атрибуты товара
                </span>
            </label>
            <label class="flex flex-col gap-2 text-sm font-semibold text-slate-700">
