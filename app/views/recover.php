        ...
        <?php if (($stage ?? 'code') === 'code'): ?>
            ...
            <div class="flex justify-center">
                <div class="grid grid-cols-2 gap-2.5 w-full max-w-xs">
                    ...
                    <a href="/?page=register" class="inline-flex items-center justify-center gap-1.5 rounded-xl border border-rose-200 bg-white/80 backdrop-blur-sm px-3 py-2.5 text-xs font-medium text-rose-700 transition hover:bg-rose-50 hover:border-rose-300">
