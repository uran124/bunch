...
<section class="flex flex-col gap-6">
    ...
    <form id="standing-form" action="/admin-supply-standing" method="post" enctype="multipart/form-data" class="space-y-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm shadow-rose-50/60 ring-1 ring-transparent">
        ...
        <div class="grid gap-3 lg:grid-cols-2">
            ...
            <label class="flex flex-col gap-2 text-sm font-semibold text-slate-700 lg:col-span-2">
                Описание поставки
                <textarea name="description" rows="3" class="w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm text-slate-900 shadow-sm focus:border-rose-300 focus:outline-none focus:ring-2 focus:ring-rose-200" placeholder="Например: крупный бутон, матовые лепестки, высокая стойкость."></textarea>
            </label>
            <label class="flex flex-col gap-2 text-sm font-semibold text-slate-700">
